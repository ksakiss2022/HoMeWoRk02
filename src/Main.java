public class Main {
    public static void main(String[] args) {
        ...
        System.out.println ("Ответ задача 4: 1 диета:" + firstDiet + " дней, 2 диета:" + secondDiet + " дней,"
        ...
        System.out.println("Ответ задача 5 : Ежемесячный доход Маши составил = " + mTotal + " руб., " +
